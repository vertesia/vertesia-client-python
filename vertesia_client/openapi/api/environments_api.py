...
class EnvironmentsApi:
    ...
    def disable_environment_model(
        ...
        _param = self._disable_environment_model_serialize(
            env_id=env_id,
            model_id=model_id,
            x_api_version=x_api_version,
            _request_auth=_request_auth,
    ...
    @validate_call
    def disable_environment_model_with_http_info(
        self,
        env_id: StrictStr,
        model_id: StrictStr,
        x_api_version: Annotated[Optional[StrictStr], Field(description="Optional Vertesia API version header. Use `20260319` for the current stable API shape.")] = None,
    ...
    @validate_call
    def disable_environment_model_without_preload_content(
        self,
        env_id: StrictStr,
        model_id: StrictStr,
        x_api_version: Annotated[Optional[StrictStr], Field(description="Optional Vertesia API version header. Use `20260319` for the current stable API shape.")] = None,
    ...
    def _disable_environment_model_serialize(
        self,
        env_id,
        model_id,
        x_api_version,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/environments/{envId}/models/enabled/{modelId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _enable_environment_model_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if enable_environment_model_payload is not None:
            _body_params = enable_environment_model_payload
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/environments/{envId}/models/enabled',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
