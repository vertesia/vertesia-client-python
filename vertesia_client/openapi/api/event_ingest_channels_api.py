...
class EventIngestChannelsApi:
    ...
    def create_event_ingest_channel(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "EventIngestChannelMutationResponse",
            '500': "ErrorResponse",
            '4XX': "ErrorResponse",
        }
    ...
    def _create_event_ingest_channel_serialize(
        ...
        if create_event_ingest_channel_payload is not None:
            _body_params = create_event_ingest_channel_payload
    ...
    def delete_event_ingest_channel(
        ...
        **Required permissions:** `workflow:admin`
        ...
        _param = self._delete_event_ingest_channel_serialize(
    ...
    def _delete_event_ingest_channel_serialize(
        self,
        channel_id,
        x_api_version,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/events/channels/{channelId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_event_ingest_channel(
        ...
        **Required permissions:** `workflow:read`
        ...
        _param = self._get_event_ingest_channel_serialize(
            channel_id=channel_id,
            x_api_version=x_api_version,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    def get_event_ingest_channel_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[EventIngestChannel]:
        """Retrieve an event ingest channel
    ...
    def _get_event_ingest_channel_serialize(
        self,
        channel_id,
        x_api_version,
        _request_auth,
    ...
    def list_event_ingest_channels(
        ...
        **Required permissions:** `workflow:read`
        ...
        _param = self._list_event_ingest_channels_serialize(
            x_api_version=x_api_version,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    def list_event_ingest_channels_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[EventIngestChannel]]:
        """List event ingest channels
    ...
    def _list_event_ingest_channels_serialize(
        self,
        x_api_version,
        _request_auth,
        _content_type,
    ...
    def _update_event_ingest_channel_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if update_event_ingest_channel_payload is not None:
            _body_params = update_event_ingest_channel_payload
