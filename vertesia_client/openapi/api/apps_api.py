...
class AppsApi:
    ...
    @validate_call
    def delete_mcp_collection_api_key(
        self,
        id: StrictStr,
        ...
        _param = self._delete_mcp_collection_api_key_serialize(
            id=id,
    ...
    @validate_call
    def delete_mcp_collection_api_key_with_http_info(
        self,
        id: StrictStr,
        collection_id: StrictStr,
        x_api_version: Annotated[str, Field(min_length=1, strict=True, description="Required Vertesia API version header. Use `20260803` for the current stable API shape.")],
    ...
    @validate_call
    def delete_mcp_collection_api_key_without_preload_content(
        self,
        id: StrictStr,
        collection_id: StrictStr,
        x_api_version: Annotated[str, Field(min_length=1, strict=True, description="Required Vertesia API version header. Use `20260803` for the current stable API shape.")],
    ...
    def _delete_mcp_collection_api_key_serialize(
        self,
        id,
        collection_id,
        x_api_version,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/apps/{id}/collections/{collectionId}/api-key',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def get_mcp_collection_api_key_status(
        self,
        id: StrictStr,
        collection_id: StrictStr,
        x_api_version: Annotated[str, Field(min_length=1, strict=True, description="Required Vertesia API version header. Use `20260803` for the current stable API shape.")],
        ...
        _param = self._get_mcp_collection_api_key_status_serialize(
            id=id,
            collection_id=collection_id,
            x_api_version=x_api_version,
            _request_auth=_request_auth,
    ...
    @validate_call
    def get_mcp_collection_api_key_status_with_http_info(
        self,
        id: StrictStr,
        collection_id: StrictStr,
        x_api_version: Annotated[str, Field(min_length=1, strict=True, description="Required Vertesia API version header. Use `20260803` for the current stable API shape.")],
    ...
    @validate_call
    def get_mcp_collection_api_key_status_without_preload_content(
        self,
        id: StrictStr,
        collection_id: StrictStr,
        x_api_version: Annotated[str, Field(min_length=1, strict=True, description="Required Vertesia API version header. Use `20260803` for the current stable API shape.")],
    ...
    def _get_mcp_collection_api_key_status_serialize(
        self,
        id,
        collection_id,
        x_api_version,
    ...
    @validate_call
    def set_mcp_collection_api_key(
        self,
        id: StrictStr,
        collection_id: StrictStr,
        x_api_version: Annotated[str, Field(min_length=1, strict=True, description="Required Vertesia API version header. Use `20260803` for the current stable API shape.")],
    ...
    @validate_call
    def set_mcp_collection_api_key_with_http_info(
        self,
        id: StrictStr,
        collection_id: StrictStr,
        x_api_version: Annotated[str, Field(min_length=1, strict=True, description="Required Vertesia API version header. Use `20260803` for the current stable API shape.")],
    ...
    @validate_call
    def set_mcp_collection_api_key_without_preload_content(
        self,
        id: StrictStr,
        collection_id: StrictStr,
        x_api_version: Annotated[str, Field(min_length=1, strict=True, description="Required Vertesia API version header. Use `20260803` for the current stable API shape.")],
    ...
    def _set_mcp_collection_api_key_serialize(
        self,
        id,
        collection_id,
        x_api_version,
        ...
        # process the form parameters
        # process the body parameter
        if set_mcp_api_key_request is not None:
            _body_params = set_mcp_api_key_request
    ...
    @validate_call
    def update_app_installation_o_auth_approval(
        self,
        install_id: StrictStr,
        x_api_version: Annotated[str, Field(min_length=1, strict=True, description="Required Vertesia API version header. Use `20260803` for the current stable API shape.")],
        update_app_installation_o_auth_approval_payload: UpdateAppInstallationOAuthApprovalPayload,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        """Approve or revoke OAuth permissions for an app installation
        ...
        **Required permissions:** `project:admin`
        ...
        :param x_api_version: Required Vertesia API version header. Use `20260803` for the current stable API shape. (required)
        :type x_api_version: str
        :param update_app_installation_o_auth_approval_payload: (required)
        :type update_app_installation_o_auth_approval_payload: UpdateAppInstallationOAuthApprovalPayload
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._update_app_installation_o_auth_approval_serialize(
            install_id=install_id,
            x_api_version=x_api_version,
            update_app_installation_o_auth_approval_payload=update_app_installation_o_auth_approval_payload,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def update_app_installation_o_auth_approval_with_http_info(
        self,
        install_id: StrictStr,
        x_api_version: Annotated[str, Field(min_length=1, strict=True, description="Required Vertesia API version header. Use `20260803` for the current stable API shape.")],
        update_app_installation_o_auth_approval_payload: UpdateAppInstallationOAuthApprovalPayload,
    ...
    @validate_call
    def update_app_installation_o_auth_approval_without_preload_content(
        self,
        install_id: StrictStr,
        x_api_version: Annotated[str, Field(min_length=1, strict=True, description="Required Vertesia API version header. Use `20260803` for the current stable API shape.")],
        update_app_installation_o_auth_approval_payload: UpdateAppInstallationOAuthApprovalPayload,
    ...
    def _update_app_installation_o_auth_approval_serialize(
        self,
        install_id,
        x_api_version,
        update_app_installation_o_auth_approval_payload,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if update_app_installation_o_auth_approval_payload is not None:
            _body_params = update_app_installation_o_auth_approval_payload
        ...
        return self.api_client.param_serialize(
            method='PUT',
            resource_path='/apps/installations/{installId}/oauth-approval',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
