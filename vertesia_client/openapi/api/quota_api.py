...
class QuotaApi:
    ...
    def get_quota_standing(
        ...
        _param = self._get_quota_standing_serialize(
    ...
    def get_quota_standing_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[QuotaStandingResponse]:
        """Get quota standing
    ...
    def _get_quota_standing_serialize(
        self,
        x_api_version,
        _request_auth,
        _content_type,
    ...
    def get_quota_tier(
        ...
        _param = self._get_quota_tier_serialize(
            x_api_version=x_api_version,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
