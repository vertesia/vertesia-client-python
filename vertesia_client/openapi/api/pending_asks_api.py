...
class PendingAsksApi:
    ...
    def get_pending_ask(
        ...
        _param = self._get_pending_ask_serialize(
            ask_id=ask_id,
    ...
    def _get_pending_ask_serialize(
        self,
        ask_id,
        x_api_version,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/pending-asks/{askId}',
    ...
    def list_pending_asks(
        ...
        _param = self._list_pending_asks_serialize(
            x_api_version=x_api_version,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    def list_pending_asks_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ListPendingAsksResponse]:
        """List pending agent questions
    ...
    def _list_pending_asks_serialize(
        self,
        x_api_version,
        _request_auth,
        _content_type,
    ...
    def register_pending_ask(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "RegisterPendingAskResponse",
            '500': "ErrorResponse",
            '4XX': "ErrorResponse",
        }
        response_data = self.api_client.call_api(
    ...
    def register_pending_ask_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[RegisterPendingAskResponse]:
        """Register a pending agent question
    ...
    def _register_pending_ask_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if register_pending_ask_request is not None:
            _body_params = register_pending_ask_request
    ...
    def resolve_pending_ask_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ResolvePendingAskResponse]:
        """Resolve a pending agent question
    ...
    def _resolve_pending_ask_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if resolve_pending_ask_request is not None:
            _body_params = resolve_pending_ask_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/pending-asks/{askId}/resolve',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
