...
class RenderingApi:
    ...
    def create_rendering_job(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "RenderMarkdownStartResponse",
            '500': "ErrorResponse",
            '4XX': "ErrorResponse",
        }
    ...
    def create_rendering_job_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[RenderMarkdownStartResponse]:
        """Create a rendering job
    ...
    def _create_rendering_job_serialize(
        ...
        if render_markdown_payload is not None:
            _body_params = render_markdown_payload
    ...
    def get_rendering_job_status(
        ...
        _param = self._get_rendering_job_status_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "RenderMarkdownStatusResponse",
            '500': "ErrorResponse",
            '4XX': "ErrorResponse",
        }
        response_data = self.api_client.call_api(
    ...
    @validate_call
    def get_rendering_job_status_with_http_info(
        self,
        workflow_id: StrictStr,
        workflow_run_id: StrictStr,
        x_api_version: Annotated[Optional[StrictStr], Field(description="Optional Vertesia API version header. Use `20260319` for the current stable API shape.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[RenderMarkdownStatusResponse]:
        """Get rendering job status
    ...
    @validate_call
    def get_rendering_job_status_without_preload_content(
        self,
        workflow_id: StrictStr,
        workflow_run_id: StrictStr,
        x_api_version: Annotated[Optional[StrictStr], Field(description="Optional Vertesia API version header. Use `20260319` for the current stable API shape.")] = None,
    ...
    def _get_rendering_job_status_serialize(
        self,
        workflow_id,
        workflow_run_id,
        x_api_version,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/rendering/jobs/status',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
