...
class NamedInteractionExecutionPayload(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["data", "config", "result_schema", "stream", "do_validate", "tags", "conversation", "tool_definitions", "workflow", "prompts", "asyncCompletion", "interaction"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NamedInteractionExecutionPayload from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NamedInteractionExecutionPayload from a dict"""
        if obj is None:
            return None
