...
class AppInstallation(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "project", "manifest", "oauth_approval", "settings", "tool_allowlist", "oauth_bindings", "provider_bindings", "access_control", "created_at", "updated_at"]
