...
class BedrockGptOssOptions(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["_option_id", "max_tokens", "temperature", "top_p", "stop_sequence", "reasoning_effort", "frequency_penalty", "presence_penalty", "service_tier"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BedrockGptOssOptions from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BedrockGptOssOptions from a dict"""
        if obj is None:
            return None
