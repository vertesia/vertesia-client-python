...
class UpdateSecretRequest(BaseModel):
    ...
    clear_totp: Optional[StrictBool] = None
    clear_oauth: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["kind", "metadata", "secret", "clear_username_secret", "clear_password", "clear_totp", "clear_oauth"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "clear_totp": obj.get("clear_totp"),
            "clear_oauth": obj.get("clear_oauth")
        })
        return _obj
