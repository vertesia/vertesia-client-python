...
class CompositeAppConfig(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "project", "card", "logo", "message", "switchers", "sidebar", "header", "userMenu", "theme", "homePlugin", "apps", "menu"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CompositeAppConfig from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CompositeAppConfig from a dict"""
        if obj is None:
            return None
