...
class BedrockAI21Options(BaseModel):
    """
    BedrockAI21Options
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["_option_id", "max_tokens", "temperature", "top_p", "presence_penalty", "frequency_penalty", "stop_sequence", "include_thoughts", "service_tier"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BedrockAI21Options from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BedrockAI21Options from a dict"""
        if obj is None:
            return None
