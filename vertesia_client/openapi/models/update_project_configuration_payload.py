...
class UpdateProjectConfigurationPayload(BaseModel):
    """
    ...
    oauth_clients: Optional[ProjectConfigurationOauthClients] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UpdateProjectConfigurationPayload from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of oauth_clients
        if self.oauth_clients:
            _dict['oauth_clients'] = self.oauth_clients.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UpdateProjectConfigurationPayload from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "oauth_clients": ProjectConfigurationOauthClients.from_dict(obj["oauth_clients"]) if obj.get("oauth_clients") is not None else None,
