...
class StartAppScaffoldRequest(BaseModel):
    ...
    oauth_scopes: Optional[List[StrictStr]] = Field(default=None, description="App permissions declared in generated source. Defaults to sign-in only.")
    ...
    __properties: ClassVar[List[str]] = ["app_id", "title", "description", "modules", "oauth_scopes", "appgen_package_spec", "create_version"]
