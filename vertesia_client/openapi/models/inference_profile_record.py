...
class InferenceProfileRecord(BaseModel):
    """
    A project-scoped inference profile stored as a MongoDB document.
    """ # noqa: E501
    ...
    created_at: datetime
    updated_at: datetime
    __properties: ClassVar[List[str]] = ["name", "description", "environment", "model", "model_options", "id", "project", "created_at", "updated_at"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of InferenceProfileRecord from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of InferenceProfileRecord from a dict"""
        if obj is None:
            return None
