...
class UpdateAppPayload(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["oauth_scopes", "name", "visibility", "title", "description", "publisher", "icon", "color", "preview_screenshot", "status", "ui", "tool_collections", "oauth_providers", "interactions", "settings_schema", "capabilities", "endpoint", "endpoint_overrides", "version", "source", "tags", "access_control", "expected_edit_revision"]
