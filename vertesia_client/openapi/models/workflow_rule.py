...
class WorkflowRule(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "description", "tags", "updated_by", "created_by", "created_at", "updated_at", "endpoint", "input_type", "match", "config", "debug", "customer_override", "task_queue"]
