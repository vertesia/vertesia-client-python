...
class ExecutionEnvironmentUpdatePayload(BaseModel):
    """
    ExecutionEnvironmentUpdatePayload
    """ # noqa: E501
    name: Optional[StrictStr] = None
    provider: Optional[SupportedProviders] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ExecutionEnvironmentUpdatePayload from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ExecutionEnvironmentUpdatePayload from a dict"""
        if obj is None:
            return None
