...
class AppPackage(BaseModel):
    ...
    AppPackage
    """ # noqa: E501
    oauth_scopes: Optional[List[StrictStr]] = Field(default=None, description="OAuth scopes requested by the app. Users must consent to project permissions.")
    ...
    dashboards: Optional[List[AppDashboardDefinition]] = Field(default=None, description="Dashboards provided by the app.")
    ...
    hooks: Optional[AppPackageHooks] = None
    subscriptions: Optional[List[AppEventSubscriptionDefinition]] = Field(default=None, description="Event subscriptions contributed by the app.")
    __properties: ClassVar[List[str]] = ["oauth_scopes", "ui", "tools", "skills", "interactions", "types", "processes", "views", "templates", "dashboards", "widgets", "activities", "settings_schema", "hooks", "subscriptions"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "dashboards": [AppDashboardDefinition.from_dict(_item) for _item in obj["dashboards"]] if obj.get("dashboards") is not None else None,
            "widgets": dict(
            ...
            "hooks": AppPackageHooks.from_dict(obj["hooks"]) if obj.get("hooks") is not None else None,
            "subscriptions": [AppEventSubscriptionDefinition.from_dict(_item) for _item in obj["subscriptions"]] if obj.get("subscriptions") is not None else None
        })
        return _obj
