...
class AppPackage(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["ui", "tools", "skills", "interactions", "types", "processes", "views", "templates", "dashboards", "widgets", "activities", "settings_schema", "hooks", "subscriptions"]
