...
class UpdateApiKeyPayload(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "role", "enabled", "scim_provisioning", "properties", "clearance", "compartments"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UpdateApiKeyPayload from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UpdateApiKeyPayload from a dict"""
        if obj is None:
            return None
