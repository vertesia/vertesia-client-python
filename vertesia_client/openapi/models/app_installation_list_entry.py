...
class AppInstallationListEntry(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "project", "settings", "tool_allowlist", "oauth_bindings", "provider_bindings", "created_at", "updated_at", "manifest", "oauth_collection_ids"]
