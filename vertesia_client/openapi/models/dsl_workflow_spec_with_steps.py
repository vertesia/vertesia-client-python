...
class DSLWorkflowSpecWithSteps(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DSLWorkflowSpecWithSteps from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DSLWorkflowSpecWithSteps from a dict"""
        if obj is None:
            return None
...
DSLWorkflowSpecWithSteps.model_rebuild(raise_errors=False)
