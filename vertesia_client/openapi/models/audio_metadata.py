...
class AudioMetadata(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["type", "size", "languages", "location", "generation_runs", "etag", "rendered_text_etag", "renditions", "embedded", "type_detection", "locate", "vision_evidence", "duration", "transcript"]
