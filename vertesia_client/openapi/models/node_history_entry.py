...
class NodeHistoryEntry(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "node", "attempt", "entered_at", "exited_at", "status", "context_diff", "data_ref", "sequence", "child_run_id", "child_workflow_id", "child_workflow_run_id"]
