...
class DSLWorkflowDefinition(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["name", "description", "tags", "steps", "activities", "vars", "options", "result", "debug_mode", "id", "updated_by", "created_by", "created_at", "updated_at", "input_schema"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DSLWorkflowDefinition from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DSLWorkflowDefinition from a dict"""
        if obj is None:
            return None
