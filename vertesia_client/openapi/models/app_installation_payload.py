...
class AppInstallationPayload(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each value in api_key_params (dict)
        _field_dict = {}
        if self.api_key_params:
            for _key_api_key_params in self.api_key_params:
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "api_key_params": dict(
                (_k, McpApiKeyCredential.from_dict(_v))
                for _k, _v in obj["api_key_params"].items()
            )
