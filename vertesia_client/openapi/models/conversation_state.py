...
class ConversationState(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of each value in tool_input_refs (dict of array)
        _field_dict_of_array = {}
        if self.tool_input_refs:
            for _key_tool_input_refs in self.tool_input_refs:
                if self.tool_input_refs[_key_tool_input_refs] is not None:
                    _field_dict_of_array[_key_tool_input_refs] = [
                        _item.to_dict() for _item in self.tool_input_refs[_key_tool_input_refs]
                    ]
            _dict['tool_input_refs'] = _field_dict_of_array
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "tool_input_refs": {
                _k: [ExternalizedToolInputRef.from_dict(_item) for _item in _v] if _v is not None else None
                for _k, _v in obj["tool_input_refs"].items()
            }
            if obj.get("tool_input_refs") is not None
            else None,
